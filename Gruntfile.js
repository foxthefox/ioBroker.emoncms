...
module.exports = function (grunt) {
    ...
    if (process.argv[2] == 'rename') {
        ...
        if (!newname) {
            console.log('Please write the new emoncms name, like: "grunt rename --name=mywidgetset" --author="Author Name"');
            process.exit();
        }
        ...
        if (fs.existsSync(__dirname + '/admin/emoncms.png')) {
            fs.renameSync(__dirname + '/admin/emoncms.png',              __dirname + '/admin/' + newname + '.png');
        }
        if (fs.existsSync(__dirname + '/widgets/emoncms.html')) {
            fs.renameSync(__dirname + '/widgets/emoncms.html',           __dirname + '/widgets/' + newname + '.html');
        }
        if (fs.existsSync(__dirname + '/widgets/emoncms/js/emoncms.js')) {
            fs.renameSync(__dirname + '/widgets/emoncms/js/emoncms.js', __dirname + '/widgets/emoncms/js/' + newname + '.js');
        }
        if (fs.existsSync(__dirname + '/widgets/emoncms')) {
            fs.renameSync(__dirname + '/widgets/emoncms',                __dirname + '/widgets/' + newname);
        }
    }
            ...
            name: {
                options: {
                    patterns: [
                        ...
                        {
                            match: /Emoncms/g,
                            replacement: newname ? (newname[0].toUpperCase() + newname.substring(1)) : 'Emoncms'
                        },
                        {
